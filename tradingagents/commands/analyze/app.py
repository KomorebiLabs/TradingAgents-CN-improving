...
from .utils import *
from .announcements import fetch_announcements, display_announcements
from .stats_handler import StatsCallbackHandler

# P7: Import Komo mascot
...
def get_user_selections():
    ...
    # P7: Show Komo mascot at startup (one-time, only in interactive mode)
    print_komo()
