...
| 提供商 | 支持模型 | 配置方式 |
|--------|----------|----------|
| **OpenAI** | GPT-5.4 系列、GPT-4o、GPT-4o-mini | `OPENAI_API_KEY` |
| **Google** | Gemini 3.1/3.0 系列（含 Thinking 模式） | `GOOGLE_API_KEY` |
| **Anthropic** | Claude 4.6/4.5/4.0 系列（含 Effort 控制） | `ANTHROPIC_API_KEY` |
| **DeepSeek** | DeepSeek V3/Chat 系列 | `DEEPSEEK_API_KEY` |
| **Qwen（阿里云）** | Qwen 系列 | `DASHSCOPE_API_KEY` |
